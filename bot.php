...
if($text == "• تحديث الصيد  •"){
	...
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Zaaakkkk/blob/main/1.php");
	file_put_contents("2.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Zaaakkkk/blob/main/2.php");
	file_put_contents("3.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Zaaakkkk/blob/main/3.php");
	file_put_contents("4.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Zaaakkkk/blob/main/4.php");
	file_put_contents("5.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Zaaakkkk/blob/main/5.php");
	file_put_contents("6.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Zaaakkkk/blob/main/6.php");
	file_put_contents("7.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Zaaakkkk/blob/main/7.php");
	file_put_contents("8.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Zaaakkkk/blob/main/8.php");
	file_put_contents("9.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Zaaakkkk/blob/main/9.php");
	file_put_contents("10.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Zaaakkkk/blob/main/10.php");
	shell_exec("pm2 stop 1.php");
	shell_exec("pm2 stop 2.php");
	shell_exec("pm2 stop 3.php");
	shell_exec("pm2 stop 4.php");
...
if($text == "• تحديث ميدلاين  •"){
	...
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Zaaakkkk/blob/main/madeline.php");
...
if($text == "• تحديث البوت   •"){
	...
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Zaaakkkk/blob/main/bot.php");
